...
void SYS_PORTS_Initialize(void)
{
    ...
    //PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_CHANGE_NOTICE_B);  // kbdoo keep commented out
    ...
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_C2RX, INPUT_PIN_RPB7 );
    ...
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_C2TX, OUTPUT_PIN_RPB6 );
